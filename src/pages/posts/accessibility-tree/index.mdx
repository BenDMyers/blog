...
People may use all sorts of assistive technologies to navigate and interact with your page. They might use screenreaders to announce page contents aloud or via a [braille display](https://en.wikipedia.org/wiki/Refreshable_braille_display). They might use speech recognition software such as Dragon NaturallySpeaking, and issue voice commands to scroll around or click buttons. They might need screen magnifiers or eye-tracking software or any number of other assistive technologies.
