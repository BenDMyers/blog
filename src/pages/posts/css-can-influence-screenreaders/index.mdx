...
> "It’s tempting to assert that if you do <i>x</i>, 'the screen reader' will announce <i>y</i>. Sometimes it really is just that simple, but in a surprising number of situations, it just isn’t that absolute." <i><Fn fn="webaim" /></i>

Be sure to test each of the following on many different browsers and with many different screenreaders.

### CSS-Generated Content

The clearest instance of CSS-as-content is _pseudo-elements_, which can inject content into the page without adding it to the DOM. For instance, Firefox and Safari both support the [`::marker`](https://www.w3.org/TR/css-lists-3/) pseudo-element,<Fn fn="caniuse" /> which injects a bullet point, number, or other indicator before a list item.
...
https://adrianroselli.com/2018/02/tables-css-display-properties-and-aria.html#TheTweet

https://medium.com/@Zwenza/the-css-speech-module-8672a87a4764

https://www.w3.org/standards/history/css3-speech