...
date: 2019-09-29
description: Buttons and hyperlinks are the cornerstones of the internet. Because they're so central to the online experience, it's crucial that we get them right for everybody.
...
```html {numberLines: true}:title=index.html
<div class="btn" tabindex="0" role="button" onclick="doSomething();">
    Click me!
</div>
```
