...
_This article covers how to alias your directories on Windows. You may be interested in [the Windows way](https://blog.benmyers.dev/alias-directories-windows/)._
