...
export const htmlWithCheckbox = `<div id="container">
...
export const jsWithCheckbox = `const toggleCheckbox = document.querySelector('.toggle-switch-semantic input');
...
export const cssWithCheckbox = `.visually-hidden {
	border: 0;
